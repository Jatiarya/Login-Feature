...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-info flex-md-nowrap p-0 shadow">
        <?php if(auth()->guard()->check()): ?>
            <label for="" class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6"> Welcome back,
                <?php echo e(auth()->user()->name); ?></label>
        <?php else: ?>
            <label for="" class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6">Account Demo</label>
        <?php endif; ?>
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <?php if(auth()->guard()->check()): ?>
                    <a href="/logout" class="nav-link px-3 text-dark">LOGOUT</a>
                <?php else: ?>
                    <a href="/login" class="nav-link px-3 text-dark">LOGIN</a>
                <?php endif; ?>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Teta Peduli - Yayasan Amal Saleh</h1>
...
<?php /**PATH C:\Users\TUF GAMING\OneDrive\Desktop\Laravel\example-app\resources\views/layouts/index.blade.php ENDPATH**/ ?>